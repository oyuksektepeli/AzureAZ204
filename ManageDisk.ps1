...
Connect-AzureRmAccount -Subscription "subscription-name"
...
$dataDisk = New-AzureRmDisk `
    -ResourceGroupName 'nc-demo-rg' `
    -DiskName 'nc-demo-win-1c-st0' `
    -Disk $diskConfig 
...
New-AzureRmSnapshot `
    ...
    -SnapshotName "nc-demo-win-1-OSDisk-1-snap-1" 
